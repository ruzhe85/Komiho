...
内置图像增强，基于CPU/GPU/NPU（高通SOC专用，需下载配套模型包）

针对漫画线条进行优化，在画质、速度和内存占用之间取得平衡。

##特别说明
Komiho图像增强基于解码端，GPU/NPU首次打开请耐心等待
AnimeVideo更适合于彩漫，Omni-Mini更适合于黑白漫，Omni-Turbo性能更强耗时更长。
GPU分块大小影响处理速度，建议选择192。
为确保使用体验，请选择适合于设备的模型。

NPU模型可能出现轻微偏色，这是速度和性能的取舍，并非BUG。
